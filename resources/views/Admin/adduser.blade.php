...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="storeuser" method="post" enctype="multipart/form-data">
                                        @csrf
 ...
 {{-- @include('includeadmin.admincontentuser') --}}
			<!-- /page content -->
