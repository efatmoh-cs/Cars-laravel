                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{ route('edittestimonial', $testimonial->id)}}"  method="post"   enctype="multipart/form-data">
                                        @csrf
                                        @method('put')
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="name" required="required" class="form-control " value="{{$testimonial->name}}" name="name">
                                                @error('name')
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" id="position" required="required" class="form-control " value="{{$testimonial->position}}" name="position" >
                                                @error('position')
                                                <div class="alert alert-danger">
                                                    <strong>Error!!</strong> {{$message}}
                                                </div>
